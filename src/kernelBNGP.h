// HEADER
double bnCorrKern(const arma::rowvec &xi, const arma::urowvec &wi, const arma::field<arma::rowvec> &vi, 
                  const arma::rowvec &xj, const arma::urowvec &wj, const arma::field<arma::rowvec> &vj, 
                  const arma::vec &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas);

void bnCorrMat(arma::mat &psi, const arma::mat &x, const arma::umat &w, const arma::field<arma::mat> &v, 
               const arma::vec &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas);

void bnCorrVecs(arma::mat &phi, const arma::mat &x0, const arma::umat &w0, const arma::field<arma::mat> &v0,
                const arma::mat &x, const arma::umat &w, const arma::field<arma::mat> &v, 
                const arma::vec &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas);

void bnLogLik(double &negloglik, arma::mat &psi, arma::mat &invPsi, double &mu, double &sigma, double &nugget, 
              const arma::vec &y, const arma::mat &x, const arma::umat &w, const arma::field<arma::mat> &v, 
              const arma::vec &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas);

void bnNewData(arma::vec &y0, arma::vec &mse, arma::vec &ei, arma::vec &ei_1, arma::vec &ei_2, double &ei_alpha, double &min_y,
               const arma::mat &x0, const arma::umat &w0, const arma::field<arma::mat> &v0,
               const arma::vec &y, const arma::mat &x, const arma::umat &w, const arma::field<arma::mat> &v, 
               double &mu, double &sigma, arma::mat &invPsi, 
               const arma::mat &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas);

void bngpParam2vec(arma::vec &alpha, arma::vec &theta, arma::field<arma::mat> &gammas, const arma::rowvec &param, 
                   const arma::uword &xDim, const arma::uword &wDim, const arma::uvec &vDim, const arma::uvec &wlv, 
                   const arma::umat &w, const arma::field<arma::mat> &v);

// BODY
// CORRELATION KERNEL IN HUNG ET AL. (2009)
double bnCorrKern(const arma::rowvec &xi, const arma::urowvec &wi, const arma::field<arma::rowvec> &vi, 
                  const arma::rowvec &xj, const arma::urowvec &wj, const arma::field<arma::rowvec> &vj, 
                  const arma::vec &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas) 
{
               ...
               const arma::vec &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas)
{
  ...
  for (uword i = 0; i < n; i++) {
    for (uword j = 0; j < i; j++) {
      ...
      double ker = bnCorrKern(xi, wi, vi, xj, wj, vj, alpha, theta, gammas);
      psi(i, j) = ker;
      psi(j, i) = ker;
    }
  }
              ...
              const arma::vec &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas)
{
  ...
  bnCorrMat(psi, x, w, v, alpha, theta, gammas);
  arma::vec eigval;
  arma::mat eigvec;
               ...
               const arma::mat &alpha, const arma::vec &theta, const arma::field<arma::mat> &gammas)
{
  ...
  bnCorrVecs(phi, x0, w0, v0, x, w, v, alpha, theta, gammas);
  arma::vec onevec(n, fill::ones);
